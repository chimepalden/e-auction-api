...
describe('UsersController', () => {
  ...
  describe('create', () => {
    it('It should create a user', async () => {
      ...
      // matching with properties of response.body (line: 61 ) and user.address (line: 69)
      // dummy userId in userStub will not match with userId returned
      // So can not match with whole response.body and user
  ...
  describe('update', () => {
    it('It should update a user', async () => {
      ...
      const user = await dbConnection.collection('users').insertOne(userStub());
      const response = await request(httpServer)
